...
class ErrorHandlingCog(commands.Cog):#The cog its self
    ...
    async def on_command_error(self, context, error):#error catcher
        ...
        if isinstance(error, commands.MissingRequiredArgument):
            ...
            await context.message.channel.send("**You cant use this command.**" + context.message.author.mention, delete_after=10)
            ...
            await context.message.channel.send("Something has gone wrong. I have logged this error."+context.message.author.mention, delete_after=10)
